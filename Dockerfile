...
RUN \
  ...
  && sed -i 's/^.*<policy domain="resource" name="width" value=".*"/>.*$/<policy domain="resource" name="width" value="64KP"/>/p' /etc/ImageMagick-6/policy.xml \
  && sed -i 's/^.*<policy domain="resource" name="height" value=".*"/>.*$/<policy domain="resource" name="width" value="64KP"/>/p' /etc/ImageMagick-6/policy.xml \
  && sed -i 's/^.*<policy domain="resource" name="disk" value=".*"/>.*$/<policy domain="resource" name="width" value="4GiB"/>/p' /etc/ImageMagick-6/policy.xml \
